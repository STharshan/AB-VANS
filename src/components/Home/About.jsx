...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I recently purchased a car from AB VANS AND MOTOR SERVICES, and the experience was fantastic from beginning to end. The entire process was smooth, transparent, and handled with real professionalism.",
    name: "Martyna Socha",
  },
